...
Shader "Reallusion/Amplify/RL5_SkinShader_Variants_3D_Tessellation"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				float FasterFresnel689( float3 N, float3 V )
				{
							...
							) : SV_Target
				{
					...
					float3 N689 = NormalWS;
					float3 V689 = ViewDirWS;
					float localFasterFresnel689 = FasterFresnel689( N689 , V689 );
					float lerpResult512 = lerp( 1.0 , SAMPLE_TEXTURE2D( _CavityMap, sampler_Linear_Repeat, uv_CavityMap ).r , ( _CavityStrength * saturate( ( 1.0 - localFasterFresnel689 ) ) ));
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;521;-2160,2048;Inherit;False;1076;576;;7;506;509;507;510;511;512;528;Cavity Map;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;687;-2128,2464;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;688;-2128,2320;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.CustomExpressionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;689;-1920,2400;Inherit;False;float NdotV = saturate(dot( N, V))@$float om = 1 - NdotV@$float oms = om * om@$return oms * oms@;1;Create;2;True;N;FLOAT3;0,0,0;In;;Inherit;False;True;V;FLOAT3;0,0,0;In;;Inherit;False;Faster Fresnel;True;False;0;;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;509;-1760,2432;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;528;-1600,2464;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=5F7F6937BA37802E7026F4402EA8D25FD191C5FD